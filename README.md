...
**Работа с данными & ETL-пайплайны**
- pandas
- Apache Airflow
- ETL pipelines
- Обработка данных
...
- Разработка REST API и интеграционных сервисов
- Реализация бизнес-логики и серверных валидаций
- Поддержка и развитие существующей серверной части приложений
- Асинхронное программирование (asyncio, HTTPX)
- Построение периодических задач / Оркестрация задач (Airflow, Celery)
- Работа с временными зонами и отправкой уведомлений
- Проектирование и поддержка реляционных моделей данных
- Интеграция Telegram-ботов и внешних API (кэширование, retry, обработка ошибок)
- Реализация систем ролей и разграничения доступа (RBAC)
- Построение ETL-пайплайнов и автоматизации данных
...
- Разработка fullstack pet-проектов
- AI-assisted development и автоматизация разработки
- Проектирование MVP и прототипирование сервисов
- Анализ и доработка существующей кодовой базы
- Работа с legacy-кодом и багфиксы

## ⚖️ Подход к разработке

- Поддерживаемая и структурированная архитектура
- Layered Architecture и Service Layer подход
- Применение SOLID
- Чёткое разделение ответственности между слоями приложения
- Надёжность и целостность данных
- Понимание принципов ACID и транзакционности
- Идемпотентность фоновых задач и API-операций
- Тестируемость ключевой бизнес-логики
- DRY и KISS как базовые принципы проектирования
- Обработка ошибок и отказоустойчивость сервисов
- Постепенное развитие решений: MVP → итерации → улучшение
- AI-assisted development с обязательной валидацией и доработкой решений
